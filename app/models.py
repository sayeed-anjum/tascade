...
class MetricsTimeGrain(str, Enum):
    HOUR = "hour"
    DAY = "day"
    WEEK = "week"
    MONTH = "month"
...
class MetricsTrendPointModel(Base):
    __tablename__ = "metrics_trend_point"
    ...
    time_grain: Mapped[MetricsTimeGrain] = mapped_column(
        SAEnum(MetricsTimeGrain, values_callable=_enum_values), nullable=False
    )
...
class MetricsBreakdownPointModel(Base):
    __tablename__ = "metrics_breakdown_point"
    ...
    metric_key: Mapped[str] = mapped_column(Text, nullable=False)
    time_grain: Mapped[MetricsTimeGrain | None] = mapped_column(
        SAEnum(MetricsTimeGrain, values_callable=_enum_values), nullable=True
    )
    time_bucket: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
...
class MetricsDrilldownModel(Base):
    __tablename__ = "metrics_drilldown"
